...
from market_maker.utils.api_client import ApiClient
...
class TradeApi(object):
    ...
    def trade_get(self, **kwargs):
        ...
        >>> thread = api.trade_get(async=True)
        >>> result = thread.get()
    ...
    def trade_get_with_http_info(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.trade_get_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def trade_get_bucketed(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.trade_get_bucketed(async=True)
        >>> result = thread.get()
    ...
    def trade_get_bucketed_with_http_info(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.trade_get_bucketed_with_http_info(async=True)
        >>> result = thread.get()
        ...
        all_params = ['bin_size', 'partial', 'symbol', 'filter', 'columns', 'count', 'start', 'reverse', 'start_time', 'end_time']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'partial' in params:
            query_params.append(('partial', params['partial']))
        if 'symbol' in params:
            query_params.append(('symbol', params['symbol']))
        if 'filter' in params:
            query_params.append(('filter', params['filter']))
